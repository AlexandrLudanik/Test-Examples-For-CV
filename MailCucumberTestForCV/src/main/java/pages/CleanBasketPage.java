...
public class CleanBasketPage {
    ...
    {
        new WebDriverWait(driver,10).until(ExpectedConditions.visibilityOf(basketLink)).click();
    }

    public void clickButtonClearFolder(){
        (new WebDriverWait(driver, 15)).until(ExpectedConditions.visibilityOf(buttonClearFolder)).click();
    }

    public void clickButtonConfirm(){
        (new WebDriverWait(driver, 15)).until(ExpectedConditions.visibilityOf(buttonConfirm)).click();
    }
